  ...
  <div class="bg-white">
    <div class="pt-6">
      ...
      <div class="max-w-2xl mx-auto pt-10 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8">
        ...
        <div class="mt-4 lg:mt-0 lg:row-span-3">
          ...
          <div class="mt-10">
            <a href="https://wa.me/{{ $settings->phone }}" target="_blank" class="text-white space-x-4 bg-green-600 hover:bg-green-600/90 focus:ring-4 focus:outline-none focus:ring-greenbg-green-600/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-greenbg-green-600/50 mr-2 mb-2">
    ...
    <form class="container mx-auto px-20" method="POST" action="{{ route('product.order', $data->id) }}" enctype="multipart/form-data">
      ...
      <div class="mb-6">
        ...
        <input type="text" id="email" name="email" class="input input-bordered w-full" value="{{ old('email') }}">
        <span></span>
      </div>
      <div class="mb-6">
        <label for="transportation" class="label">Jenis Kendaraan</label>
        <select class="select w-full select-primary" name="transportation" id="transportation">
      ...
      <div class="mb-6">
        ...
        <select class="select w-full select-primary" name="duration" id="duration">
          <option value="12 jam">12 jam</option>
          <option value="24 jam">Full Day</option>
        </select>
        <span></span>
      </div>
      <div class="mb-6">
